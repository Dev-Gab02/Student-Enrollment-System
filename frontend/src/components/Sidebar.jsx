...
export default function Sidebar() {
  ...
  const menu = [
    {"title": "Dashboard", "icon": <LayoutDashboard size={22}/>, "to": "/student"},
    {"title": "Enrollment", "icon": <FileText size={22}/>, "to": "/enroll"}
  ]
  ...
  return(
    <main className="bg-gray-900 min-h-screen w-75 flex flex-col justify-between">
      <div>
        <div>
          <h1 className="text-xl text-white font-semibold px-4 py-6">Student Portal</h1>
        </div>
